...
$url_page = $_SERVER['REQUEST_URI']; // Получаем адрес страницы
$Protokol_site = 'http://'; // Протокол сайта
$my_site = $Protokol_site.'Мій-сайт'; // Адрес мего сайта
$program_dir_url = 'IPLoger/'; //  URL папки програмы 
//-----------------------------------------------------------------------//

//-----------------------------------------------------------------------//
$appeal_local = './';
$log_dir = $appeal_local.'logs/'; //Папка лог файла
$rename_log_dir = $appeal_local.'renamed-logs/'; //Папка переименованых файлов
$program_dir = $appeal_local.$program_dir_url; // Папка програмы 
//-----------------------------------------------------------------------//

//-----------------------------------------------------------------------//
$extension_zip = '.zip'; // Расширение файла
$extension_txt = '.txt'; // Расширение файла
$extension_htaccess = '.htaccess'; // Расширение файла
$extension_php = '.php'; // Расширение файла
$arcive = 'IPLoger'.$extension_zip;
$log_file = 'log'.$extension_txt; // Имя файла
$htaccess_file = ''.$extension_htaccess; // Имя файла
$index_file = 'index'.$extension_php; // Имя файла
//-----------------------------------------------------------------------//

//-----------------------------------------------------------------------//
$masa_faila = "104857600"; // Максимальный вес файла логов в байтах
//-----------------------------------------------------------------------//
